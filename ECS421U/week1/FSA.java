...
public class FSA {
    ...
    private String checkTRelation(Transition[] a, String name) {
        ...
        for (Transition t : a) {
            ...
            if (checkT != "")
                return ("Bad " + name + " element " + t + ": " + checkT);
        }
        return "";
    }
    ...
    private String checkLabel(String l) {
        for (String s : alphabet)
            if (s == l)
                return "";
        if (l != "")
            return ("label not in alphabet (" + l + ")");
        return "";
    }
